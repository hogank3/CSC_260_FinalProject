...
public class SpawnEnemy : MonoBehaviour
{
    ...
    private void spawnEnemy()
    {
        ...
        {
            case 0: //top
                gob.transform.position = new Vector2(Random.Range(-bounds.x, bounds.x), bounds.y + 1);
                break;
            case 1: //bottom
                gob.transform.position = new Vector2(Random.Range(-bounds.x, bounds.x), -bounds.y - 1);
                break;
            case 2: //left
                gob.transform.position = new Vector2(-bounds.x - 1, Random.Range(-bounds.y, bounds.y));
                break;
            case 3: //right
                gob.transform.position = new Vector2(bounds.x + 1, Random.Range(-bounds.y, bounds.y));
                break;
